...
|----|------|--------|-------|-------|
| T001 | CLI skeleton (consult/plan/apply/doctor/mcp/update/init/check-config) | DONE | skeleton | |
| T002 | Redact + tests (FAKE fixtures) | DONE | skeleton | critical 100% |
| T003 | Apply dry-run default | DONE | skeleton | critical 100% |
| T004 | Probe tiers + unlock-rw | DONE | skeleton | |
| T005 | Knowledge RO SQLite FTS | DONE | skeleton | |
...
| T017 | Bare `hawkeye` operator session (panic path) | IN PROGRESS | cursor/operator-session-repl-688d | TTY REPL like `ollama run`; compose with T015 apply prompt |
